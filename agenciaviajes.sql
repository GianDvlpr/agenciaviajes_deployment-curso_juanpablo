...
(1, 'Maria Romero', 'correo@correo.com', 'Buenas ofertas');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(2, 'Juan Velasco', 'correo@correo.com', 'El mejor sitio de viajes!');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(3, 'Esteban Herrera', 'correo@correo.com', 'Los mejores destinos');
INSERT INTO `testimoniales` (`id`, `nombre`, `correo`, `mensaje`) VALUES
(4, 'Juan', 'Juan@correo.com', 'Soy Juan'),
(5, '123', 'Juan@correo.com', '43343'),
(6, '78777', 'Juan@correo.com', '3eee'),
(7, 'Teresa', 'Perez', 'Calidad');
